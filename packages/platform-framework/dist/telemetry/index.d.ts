...
export type DeploymentEvent = "deployment.started" | "deployment.succeeded" | "deployment.failed" | "deployment.rolled_back";
...
export declare function buildEvent(input: BuildEventInput): DoraEvent;
/** Serialize as a single NDJSON line for the collector (CloudWatch / S3 / stdout). */
export declare function serializeEvent(event: DoraEvent): string;
